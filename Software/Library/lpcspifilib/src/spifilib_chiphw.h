...
typedef struct {
	...
	__IO    uint32_t DATINTM;			/**< SPIFI intermediate data register */
	__IO    uint32_t CACHELIMIT;	/**< SPIFI cache limit register */
	union {
	...
	__IO    uint32_t MEMCMD;			/**< SPIFI memory command register */
